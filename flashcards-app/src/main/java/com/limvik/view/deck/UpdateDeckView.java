...
public class UpdateDeckView implements View {

    private static final String WELCOME = "보관함 이름을 변경합니다.";
    private static final String LOADING = "새로운 보관함 이름으로 변경중 입니다. 잠시만 기다려주세요.";
    private static final String MENU = "새로운 보관함 이름 작성 후 엔터 키를 눌러주세요.";
